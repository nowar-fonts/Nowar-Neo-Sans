...
def LocalizedFamily(p):
    result = {
        LanguageId.enUS: "Nowar Neo Sans",
        LanguageId.enGB: "Nowar Neo Sans",

        LanguageId.jaJP: "有愛新ゴシック",
        LanguageId.koKR: "有愛 네오 고딕",
        LanguageId.zhCN: "有爱新黑",
        LanguageId.zhHK: "有愛新黑",
        LanguageId.zhMO: "有愛新黑",
        LanguageId.zhSG: "有爱新黑",
        LanguageId.zhTW: "有愛新黑",
    }
...
if __name__ == "__main__":
    ...
    # otf files
    for w, wd, r, fea in product(config.fontPackWeight, [3, 5, 10], regionNameMap.keys(), powerset(featureNameMap.keys())):
        param = {
            "family": "Nowar",
            "weight": w,
            "width": wd,
